...
Een enkelvoudig HTML-hulpmiddel voor salarisadministratie. Laad een [MendriX](https://mendrix.nl/) TMS salarisrapport (`.xlsx`) in en zie direct per medewerker de opgebouwde verblijfskosten en nachttoeslag-uren over de geselecteerde periode.

## Wat doet het?

- Leest een [MendriX](https://mendrix.nl/) exportbestand in — rechtstreeks in de browser, er worden geen gegevens verstuurd
...
3. Sleep een [MendriX](https://mendrix.nl/) TMS exportbestand (`.xlsx`) op het uploadgebied, of klik om een bestand te kiezen
...
Het hulpmiddel verwacht een [MendriX](https://mendrix.nl/) TMS exportbestand in het formaat **Samenvatting voor salarisadministratie**. Klik op de knop **ℹ Hoe kom ik aan het rapport bestand?** in de applicatie voor instructies.
